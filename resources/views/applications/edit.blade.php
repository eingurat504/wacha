...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('applications.update', $application->id) }}" class="pt-3">
                        @csrf
                        @method('PUT')
                    ...
                    <form method="POST" action="{{ route('applications.update', $application->id) }}" class="pt-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="start_date" id="start_date"
                                   ...
                                   data-value="{{ old('start_date', $application->start_date) }}" placeholder="{{ __('Start Date') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="end_date" id="end_date" required
                                   ...
                                   value="{{ old('end_date', $application->end_date) }}" placeholder="{{ __('End Date') }}"/>
                            @error('end_date')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        </div>
